...
export default {
  ...
  "components/Card.vue": () => import('./_nuxt/Card-styles.17bfc007.mjs').then(interopDefault),
  "layouts/default.vue": () => import('./_nuxt/default-styles.760f979a.mjs').then(interopDefault)
}